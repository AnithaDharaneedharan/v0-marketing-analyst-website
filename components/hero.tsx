...
export function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-6 lg:px-0">
      <div className="max-w-4xl mx-auto py-20 lg:py-32 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 order-1 lg:order-2 text-center lg:text-left">
            ...
            {/* Typing role */}
            <p className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-primary mb-6 h-12 flex items-center justify-center lg:justify-start">
              {displayed}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a href="/archana-dharaneedharan-cv.pdf" className="inline-flex items-center gap-2 px-6 py-3 border border-border rounded-lg font-semibold hover:bg-secondary transition-all">
