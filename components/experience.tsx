...
export function Experience() {
 ...
 <div
 key={index}
 className="group p-6 lg:p-8 bg-secondary border border-border rounded-lg hover:border-foreground/30 transition-all duration-300"
 >
 {/* Header */}
 <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
 <div className="flex-1">
 <h3 className={`text-xl font-semibold mb-2 flex items-center gap-2 ${
 exp.featured ? "text-primary" : "text-foreground"
 }`}>
 {exp.title}
 ...
 <span
 key={i}
 className="px-3 py-1 text-sm bg-background border border-border rounded-full font-medium text-foreground"
 >
 {skill}
 </span>
 ))}
