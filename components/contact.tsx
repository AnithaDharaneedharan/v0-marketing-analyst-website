...
export function Contact() {
 ...
 <button
 onClick={copyEmail}
 className="group flex items-center gap-3 bg-foreground text-background px-6 py-3 rounded-lg hover:bg-opacity-90 transition-all font-semibold"
 >
 {copied ? (
 <>
 ...
 className="group flex items-center gap-4 p-4 bg-secondary border border-border rounded-lg hover:border-foreground/30 transition-colors"
 >
 <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center group-hover:bg-primary group-hover:text-background transition-colors">
